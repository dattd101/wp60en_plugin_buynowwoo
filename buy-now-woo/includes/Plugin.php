...
class Plugin {
	...
	public function button_template( $args ) {
		...
		?>
		<button <?php print $type; ?> name="wsb-buy-now" value="<?php echo esc_attr( $product->get_id() ); ?>" class="csbk <?php echo esc_attr( $classes ); ?>" <?php print $atts; // WPCS: xss ok. ?>><?php echo isset( $args['title'] ) ? esc_html( $args['title'] ) : ''; ?></button>
		<?php
	}
